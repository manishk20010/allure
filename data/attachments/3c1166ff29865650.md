...
Call log:
  - waiting for locator('#txtTextBox')
    - locator resolved to <input type="text" wfd-id="id6" maxlength="15" id="txtTextBox" name="txtTextBox" class="s-textbox " aria-required="#true"/>
    - fill("Test123*")
            ...
            - generic [ref=e52]:
              ...
              - table "ADA" [ref=e62]:
                - rowgroup [ref=e63]:
                  ...
                  - 'row "Enter a Username: * user895 Validate" [ref=e73]':
                    - cell "Enter a Username:" [ref=e74]:
                      - generic [ref=e75]: Enter a
                      - button "Username:" [ref=e76] [cursor=pointer]
                    - cell "* user895 Validate" [ref=e77]:
                      - generic [ref=e78]: "*"
                      - textbox "Enter a username" [ref=e79]: user895
...
> 64  |         await this.Password.fill(password1)
  ...
  95  |         
  96  |         await this.page.waitForLoadState()  
  97  |     }
  98  |   
  99  |     async next(){
  100 |             
